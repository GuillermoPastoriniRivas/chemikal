        ...
        <div class="row">
            <div class="col-md-12">
                <div class="titlepage">
                    ...
                    <p>Compmartimos los conocimientos más útiles sobre las recetas de las bebidas alcoholicas más
                        deliciosas contigo</p>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="black_bg">
                    <div class="row d_flex">
                        <div class="col-md-4">
                            <div class="store_box ">
                                <figure><img src="<?= $receta['imagen'] ?>" alt="#" /></figure>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="store_box ">
                                ...
                                <a class="read_more" href="#">Ver Receta</a>
                            </div>
...
<div class="about">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="about_box ">
                    <p>Somos un grupo de programadores que se tomó el trabajo de conseguir y agrupar las recetas de las
                        bebidas alcoholicas más famosas y deliciosas del mundo, y las compartimos contigo para que las
                        disfrutes junto con nosotros </p>
                    <a class="read_more" href="#">Read more</a>
                </div>
            ...
            <div class="col-md-6 ">
                <div class="wines">
                    ...
                    <p>It is a long established fact that a reader will be distracted by the readable content of a page
                        when looking at its layout. The point of using Lorem ere, content here', making itIt is a long
                        established fact that a reader will be distracted by the readable content of a page when looking
                        at its layout. The point of using Lorem ere, content here', making it</p>
